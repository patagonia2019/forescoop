#
# Be sure to run `pod lib lint JFWindguruPure.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'JFWindguruPure'
  s.version          = '0.1.0'
  s.summary = "This is the JFWindguruPure library to use when building weather applications."
