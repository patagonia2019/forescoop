...
class ModelTests: XCTestCase {
    ...
    func testUser() {
        ...
        XCTAssertFalse(user?.waveHeightColor.isEmpty ?? true)
        XCTAssertFalse(user?.wavePeriodColor.isEmpty ?? true)
        XCTAssertEqual(user?.temperatureColor.first?.red, 80)
        XCTAssertEqual(user?.temperatureColor.first?.green, 255)
        XCTAssertEqual(user?.temperatureColor.first?.blue, 220)
        XCTAssertEqual(user?.temperatureColor.first?.alpha, 1)
